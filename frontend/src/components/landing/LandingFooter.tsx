        ...
        <div style={{ display: "flex", gap: 48, flexWrap: "wrap" }} className="footer-links">
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <Link href={lhref("/refund")} style={{ fontSize: 14, color: "var(--text-secondary)", textDecoration: "none" }}>{t("home.refundPolicy")}</Link>
              <Link href={lhref("/dpa")} style={{ fontSize: 14, color: "var(--text-secondary)", textDecoration: "none" }}>{t("home.dpa")}</Link>
