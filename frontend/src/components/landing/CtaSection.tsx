...
export default function CtaSection() {
  ...
  return (
    <section style={{ padding: "80px 24px" }} className="section-pad">
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 24, padding: "52px 36px", position: "relative", overflow: "hidden" }} className="cta-card">
