  ...
  return (
    <section style={{ padding: "80px 24px" }} className="section-pad">
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 16, padding: "52px 36px", position: "relative", overflow: "hidden" }} className="cta-card">
        ...
        <Link href={localizePath("/register", lang)} style={{ display: "inline-block", background: "var(--accent)", color: "var(--accent-button-text)", padding: "14px 36px", borderRadius: 12, textDecoration: "none", fontWeight: 700, fontSize: 15, boxShadow: "var(--shadow-lg)" }}>
          {t("home.ctaStartNow")}
        </Link>
      </div>
    </section>
