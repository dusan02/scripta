...
const NACE_SECTION_INTRO: Record<string, string> = {
  ...
  F: "Stavebné firmy — pozemné a inžinierske stavby, špecializované stavebné práce a stavebné inštalácie. Odvetvie citlivé na cykly a šedú ekonomiku — overovanie partnerov je tu obzvlášť dôležité.",
  ...
  I: "Hotely, reštaurácie a gastronómia — ubytovacie zariadenia, stravovacie služby a catering. Odvetvie s výraznou sezónnosťou a vysokým podielom mzíd.",
  ...
  L: "Prenájom a správa nehnuteľností, realitné kancelárie a developerské projekty. Odvetvie s vysokým podielom projektových firiem (SPV) — kľúčová je kontrola vlastníctva.",
