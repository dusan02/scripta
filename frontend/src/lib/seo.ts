...
const SEO_DATA: Record<Lang, {
  ...
  sk: {
    ...
    twitterTitle: "Verifa.sk — Preverenie slovenskej firmy | Business Risk Report",
    twitterDescription: "Automatizované preverenie slovenskej firmy — posudok, fraud heatmap, predikcia úpadku a Verifa Score z 25+ registrov SR v jednom PDF.",
    orgDescription: "Automatizované preverenie slovenskej firmy — finančné, právne a forenzné riziko z štátnych registrov SR s automatizovanou analýzou finančného zdravia.",
    websiteDescription: "Automatizované preverenie slovenskej firmy — finančné, právne a forenzné riziko z štátnych registrov SR.",
  },
  en: {
    ...
    twitterTitle: "Verifa.sk — Slovak Company Verification | Business Risk Report",
    twitterDescription: "Automated verification of Slovak companies — assessment, fraud heatmap, bankruptcy prediction and Verifa Score from 25+ Slovak registries in one PDF.",
    orgDescription: "Automated verification of Slovak companies — financial, legal and forensic risk from Slovak state registries with automated financial health analysis.",
    websiteDescription: "Automated verification of Slovak companies — financial, legal and forensic risk from Slovak state registries.",
  },
  de: {
    ...
    twitterTitle: "Verifa.sk — Prüfung slowakischer Firmen | Business Risk Report",
    twitterDescription: "Automatisierte Prüfung slowakischer Firmen — Bewertung, Fraud Heatmap, Insolvenzvorhersage und Verifa Score aus 25+ slowakischen Registern in einem PDF.",
    orgDescription: "Automatisierte Prüfung slowakischer Firmen — finanzielle, rechtliche und forensische Risiken aus slowakischen Staatsregistern mit automatisierter Finanzanalyse.",
  ...
  hu: {
    ...
    twitterTitle: "Verifa.sk — Szlovák cégellenőrzés | Business Risk Report",
    twitterDescription: "Automatizált szlovák cégellenőrzés — értékelés, fraud heatmap, csődelőrejelzés és Verifa Score 25+ szlovák nyilvántartásból egyetlen PDF-ben.",
    orgDescription: "Automatizált szlovák cégellenőrzés — a vállalat pénzügyi, jogi és forenzikus kockázata szlovák állami nyilvántartásokból automatizált pénzügyi egészség elemzéssel.",
    websiteDescription: "Automatizált szlovák cégellenőrzés — a vállalat pénzügyi, jogi és forenzikus kockázata szlovák állami nyilvántartásokból.",
  },
  pl: {
    ...
    twitterTitle: "Verifa.sk — Weryfikacja słowackiej firmy | Business Risk Report",
    twitterDescription: "Zautomatyzowana weryfikacja słowackiej firmy — ocena, fraud heatmap, predykcja upadłości i Verifa Score z 25+ słowackich rejestrów w jednym PDF.",
    orgDescription: "Zautomatyzowana weryfikacja słowackiej firmy — ryzyko finansowe, prawne i forensiczne ze słowackich rejestrów państwowych z zautomatyzowaną analizą kondycji finansowej.",
    websiteDescription: "Zautomatyzowana weryfikacja słowackiej firmy — ryzyko finansowe, prawne i forensyczne ze słowackich rejestrów państwowych.",
  },
};
