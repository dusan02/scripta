...
const sk: Dict = {
  ...
  "pricing.incAiPosudok": "AI manažérske zhrnutie — posudok v prirodzenom jazyku",
...
"settings.attWarning": "Táto príloha môže výrazne zväčšiť PDF report — až o stovky strán.",
  ...
  "home.heroSubtitle": "Zadajte IČO a dostanete kompletný PDF report s AI posudkom, finančnou analýzou a Verifa Score — za minúty, nie za hodiny.",
  ...
  "home.faq9q": "Obsahuje report AI posudok firmy?",
  "home.faq9a": "Áno, každý report obsahuje AI generované manažérske zhrnutie v prirodzenom jazyku, ktoré identifikuje kľúčové riziká a odporúčania. Posudok je priamo vložiteľný do spisu alebo správy pre klienta — vhodné pre právnikov, notárov a účtovníkov.",
...
const en: Dict = {
  ...
  "pricing.incAiPosudok": "AI executive summary — assessment in natural language",
...
"settings.attWarning": "This attachment can significantly increase the PDF report — by hundreds of pages.",
  ...
  "home.heroSubtitle": "Enter a company ID and get a complete PDF report with AI assessment, financial analysis and Verifa Score — in minutes, not hours.",
  ...
  "home.faq9q": "Does the report include an AI assessment of the company?",
  "home.faq9a": "Yes, every report includes an AI-generated executive summary in natural language that identifies key risks and recommendations. The assessment can be directly embedded in a client file or report — suitable for lawyers, notaries, and accountants.",
...
const de: Dict = {
  ...
  "pricing.incAiPosudok": "AI-Management-Zusammenfassung — Gutachten in natürlicher Sprache",
...
"settings.attWarning": "Dieser Anhang kann den PDF-Bericht erheblich vergrößern — um Hunderte Seiten.",
  ...
  "home.heroSubtitle": "Geben Sie eine Firmen-ID ein und erhalten Sie einen vollständigen PDF-Bericht mit AI-Gutachten, Finanzanalyse und Verifa Score — in Minuten, nicht in Stunden.",
  ...
  "home.faq9q": "Enthält der Bericht ein AI-Gutachten des Unternehmens?",
  "home.faq9a": "Ja, jeder Bericht enthält eine AI-generierte Management-Zusammenfassung in natürlicher Sprache, die Kernrisiken und Empfehlungen identifiziert. Das Gutachten lässt sich direkt in eine Akte oder einen Mandantenbericht einfügen — geeignet für Anwälte, Notare und Steuerberater.",
