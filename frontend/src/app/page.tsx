        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", flexWrap: "wrap", justifyContent: "space-between", gap: 32 }} className="footer-cols">
          <div style={{ flex: "1 1 300px" }}>
            ...
            <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
              <a href="mailto:info@verifa.sk" style={{ fontSize: 13, color: "var(--text-secondary)", textDecoration: "none" }}>info@verifa.sk</a>
              <span style={{ color: "var(--text-muted)", fontSize: 13 }}>·</span>
              <span style={{ fontSize: 13, color: "var(--text-muted)" }}>Slovenská republika</span>
            </div>
          </div>
          ...
          <div style={{ display: "flex", gap: 48, flexWrap: "wrap" }} className="footer-links">
            ...
            <div>
              <h4 style={{ fontSize: 13, fontWeight: 700, marginBottom: 12, textTransform: "uppercase", letterSpacing: "0.05em", color: "var(--text-muted)" }}>Účet</h4>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
