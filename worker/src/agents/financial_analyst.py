...
- `hruba_marza` (Gross profit): V SK GAAP hľadaj riadok 'Hrubý zisk' / 'Gross profit' alebo 'Pridaná hodnota' (Value added). V IFRS hľadaj 'Gross profit'. NIKDY nedopočítavaj matematicky! Ak hrubá marža alebo pridaná hodnota nie je explicitne ako číslo uvedená v dokumente, vráť null. Systém ju neskôr dopočíta sám.
